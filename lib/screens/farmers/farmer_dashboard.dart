...
class _FarmerDashboardState extends State<FarmerDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Farmer Dashboard", style: GoogleFonts.poppins()),
  ...
  Widget _buildDashboardCards() {
    return Row(
      ...
      children: [
        _buildDashboardCard("Total Products", farmerData!["totalProducts"].toString(), Icons.local_florist),
        _buildDashboardCard("Total Orders", farmerData!["totalOrders"].toString(), Icons.shopping_basket),
        _buildDashboardCard("Pending Negotiations", farmerData!["pendingNegotiations"].toString(), Icons.chat),
      ],
    );
  }
